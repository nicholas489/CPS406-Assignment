...
| POST   | `api/event/join`             | Allows a user to join an event                                              | `JwtMiddlewareUser`  | `{ "event_id": 1, "user_email": "user@example.com" }`                                                  |
| DELETE | `api/event/leave`            | Allows a user to leave an event                                             | `JwtMiddlewareUser`  | `{ "event_id": 1, "user_email": "user@example.com" }`                                                  |
